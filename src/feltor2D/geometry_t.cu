...
int main()
{
    ...
    solovev::DeltaFunction deltaf(psip,0.01,-0.1);

    dg::Grid2d<double> grid(Rmin,Rmax,Zmin,Zmax, n,Nx,Ny,dg::NEU, dg::NEU);
    ...
    dg::HVec hvisual18 = dg::evaluate( zonalflow,grid);
    dg::blas1::pointwiseDot(hvisual14, hvisual18, hvisual18);
...
//     dg::blas1::pointwiseDot(hvisual8, hvisual18, hvisual18);
    ...
    //Compute flux surface average of psi
