...
int main( int argc, char* argv[])
{
    ...
    if (argc == 5)
    {
        ...
        dg::cylindrical::Grid<dg::DVec > grid_in( Rminin,Rmaxin, Zminin,Zmaxin, 0, 2.*M_PI, pin.n, pin.Nx, pin.Ny, pin.Nz, pin.bc, pin.bc, dg::PER);
    ...
    eule::Rolkar<dg::cylindrical::Grid<dg::DVec>, dg::DS<DFA, dg::DMatrix, dg::DVec>, dg::DMatrix, dg::DVec > rolkar( grid, p,gp);
    std::cout << "Done!\n";
