...
\begin{subequations}
\begin{align}
B(x)^{-1} = \kappa x +1-\kappa X\quad \Gamma_1 = \sqrt{1- \tau\nabla^2}^{-1}\\
...
\begin{subequations}
\begin{align}
B(x)^{-1} = \kappa x +1-\kappa X\quad \Gamma_1 = (1- \tau/2\nabla^2)^{-1}\\
...
equations  & char & "global" & "global" &local, local-arbpolO2, global, global-arbpolO2, global-arbpolO4, gravity\_local, gravity\_global, drift\_global \\
