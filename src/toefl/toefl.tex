...
\begin{subequations}
\begin{align}
B(x)^{-1} = \kappa x +1-\kappa X l_x\quad \Gamma_1 = ( 1- 0.5\tau\nabla^2)^{-1}\\
...
\begin{subequations}
\begin{align}
B(x)^{-1} = \kappa x +1-\kappa X l_x\\
 \nabla \cdot \left(\frac{n}{B^2} \nabla \phi\right) = \rho \quad
 \text{Boussinesq:}\quad \nabla^2\phi = \rho \frac{B^2}{n} \\
\psi = \frac{1}{2} \frac{(\nabla\phi)^2}{B^2}\\
 \frac{\partial n}{\partial t}     = 
    \frac{1}{B}\{ n, \phi\} 
  + \kappa n\frac{\partial \phi}{\partial y} 
...
sigma      & float &10     & - & blob variance in units of $\rho_s$ \\
posX       & float &0.3    & - & blob x-position in units of $l_x$ \\
posY       & float &0.5    & - & blob y-position in units of $l_y$ \\
lx         & float &200    & - & $l_x$ in units of $\rho_s$ \\
ly         & float &200    & - & $l_y$ in units of $\rho_s$ \\
