...
\begin{align}\label{eq:gamma1def} 
 \Gamma_{1,i} f&:= e^{-\rho_i^2/2, -\Delta_\perp} f \approx \frac{1}{1-\frac{\rho_i^2}{2}\vec{\nabla}_\perp^2} f. & 
  \Gamma_{1,i}^\dagger f&:= \frac{1}{1-\vec{\nabla}_\perp^2\frac{\rho_i^2}{2}} f.
\end{align}
\begin{align}\label{eq:gamma2def}
 \Gamma_{2,i} f&: = \frac{\rho_i^2}{2} e^{-\rho_i^2/2, -\Delta_\perp} \Delta_\perp f \approx \frac{\frac{\rho_i^2}{2}\vec{\nabla}_\perp^2}{\left(1-\frac{\rho_i^2}{2}\vec{\nabla}_\perp^2\right)^2} f.&
...
flrmode  & integer & 1    & - &const FLR (0), dyn. FLR (1), matrix product FLR (2)\\
\bottomrule
\end{longtable}
