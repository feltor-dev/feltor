...
int main( int argc, char* argv[])
{
    ...
    std::vector< std::tuple<std::string, std::string, dg::geo::CylindricalFunctor >> map{
        ...
        {"ClosedFieldlineRegion", "Region of closed fieldlines", dg::compose( [](bool x){ return double(x);}, dg::geo::ClosedFieldlineRegion( mag) )},
        {"SOL", "The scrape off layer region", dg::compose( [](bool x){ return double(x);}, dg::geo::SOLRegion( mag, wall) )},
        ////
