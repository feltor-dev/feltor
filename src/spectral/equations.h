...
void Equations::operator()( QuadMat<complex,2>& c, const double laplace, const complex dy) const
{
    ...
    c(0,0) = P*phi[0] - curv - d + nu*pow(laplace, 3); c(0,1) = P*phi[1];
    c(1,0) = Q*phi[0];                      c(1,1) = Q*phi[1] + tau_i*curv + nu*pow(laplace,3);
}
void Equations::operator()( QuadMat<complex,3>& c, const double laplace, const complex dy) const
{
    ...
    */
    c(0,0) = P*phi[0] - curv - d + nu*pow(laplace,3); c(0,1) = P*phi[1];                       c(0,2) = P*phi[2];
    c(1,0) = Q*phi[0];                      c(1,1) = Q*phi[1] + tau_i*curv + nu*pow(laplace,3); c(1,2) = Q*phi[2];
    c(2,0) = R*phi[0];                      c(2,1) = R*phi[1];                       c(2,2) = R*phi[2] + tau_z*curv + nu*pow(laplace,3);
}
