...
asela::    3d gyrofluid electrodynamic model
...
asela2d::  2d gyrofluid electrodynamic model (a reduction of asela)

feltor2d::  2d gyrofluid electrodynamic model (a reduction of feltor)
