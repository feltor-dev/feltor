...
\begin{align}
  \vec B(R) := \frac{R_0}{R}\vec{ \hat e_\varphi}
  \label{}
\end{align}
We then have $\bhat = \vec{\hat e_\varphi}$ and $\vec\kappa = -\frac{1}{R}\vec{ \hat e_R}$. The curvature operators simplify to
\begin{align}
  \vec{ \mathcal K_\kappa} &= \vec{ \mathcal K_{\nabla B}} = -\frac{1}{R_0} \vec{\hat e_Z} \\
\vec{ \mathcal K} &= -\frac{2}{R_0}\vec{\hat e_Z}
  \label{}
\end{align}
We have
\begin{subequations}
...
\begin{align}
 \vec{B} &= \frac{R_0I(\psi)}{R} \vec{\hat{e}}_{\varphi} + \frac{R_0}{R}\left[\frac{\partial \psi}{\partial Z} \vec{\hat{e}}_R 
...
For the sake of clarity we define the poloidal magnetic field \( \vec{B}_p = \frac{R_0}{R}\left( \frac{\partial \psi}{\partial Z}\vec{\hat{e}}_R - \frac{\partial \psi}{\partial R}\vec{\hat{e}}_Z\right)
\) and the toroidal magnetic field \(\vec{B}_t =\frac{R_0I}{R} \vec{\hat{e}}_{\varphi}\).
The unit vectors are denoted by \(\vec{\hat{e}}_{R}\), \(\vec{\hat{e}}_{Z}\), \(\vec{\hat{e}}_{\varphi}\). Note that $B^R=B_R$ and $B^Z=B_Z$ whereas
...
\vec{ \mathcal{K} }_{\vec{\nabla}  B}  &\approx  -\frac{1}{B^2}\frac{\partial B}{\partial Z}\vec{\hat e_R} +\frac{1}{B^2} \frac{\partial B}{\partial R}\vec{\hat e_Z} &
%\vec{\hat e }_\varphi \times \vec{\nabla} B, &
...
\subsubsection{Without approximation}
We have
\begin{align}
...
Let us approximate
\begin{align}
\bhat\times\kappa \approx \nabla\times\bhat
\label{}
\end{align}
This is in fact a sufficient condition for $\nabla\cdot \vec{ \mathcal K} = 0$.
We can then explicitly write
\begin{align}
\vec K_{\nabla B}^R &= -\frac{R_0 I}{B^3R}\frac{\partial B}{\partial Z} \equiv -\bhat^\varphi \frac{1}{B^2}\frac{\partial B}{\partial Z}\\
\vec K_{\nabla B}^Z &= \frac{R_0 I}{B^3R}\frac{\partial \psi}{\partial R}\equiv \bhat^\varphi \frac{1}{B^2}\frac{\partial B}{\partial R}\\
...
and
\begin{align}
\vec K_\kappa^R &= \frac{R_0 }{B^2R}\left( \frac{\partial I}{\partial Z} -\frac{I}{B}\frac{\partial B}{\partial Z}\right) \\
\vec K_\kappa^Z &= \frac{R_0 }{B^2R} \left( \frac{I}{B}\frac{\partial B}{\partial R} - \frac{\partial I}{\partial R} \right)\\
\vec K_\kappa^\varphi &= \frac{1}{B^2R^2}\left(
