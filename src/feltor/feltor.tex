...
\begin{align}\label{eq:perpdiffNT}
 \Lambda_{n_e,\perp} &=  -\nu_\perp \vec{\nabla}_\perp^4 n_e &
 \Lambda_{N_i,\perp} &=  -\nu_\perp \vec{\nabla}_\perp^4 N_i  & \\
 \Lambda_{u_e,\perp} &=  -\nu_\perp \vec{\nabla}_\perp^4 (u_e - eA_\parallel/m_e)  &
 \Lambda_{U_i,\perp} &=  -\nu_\perp \vec{\nabla}_\perp^4 (U_i + eA_\parallel/m_i)
\end{align}
...
electric potential, "balance": $n_e=N_i$, ExB vorticity equals ion diamagnetic vorticity
\\
