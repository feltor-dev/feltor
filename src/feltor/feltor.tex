...
The flux surface average of a function $f(R,Z,\varphi)$ is given by the formula
\begin{align}\label{eq:fsa}
\langle f \rangle_{\psi_{p0}} :=
\frac{ \int_{\psi_p = \psi_{p0} } f\dA}{\int_{\psi_p = \psi_{p0} } \dA} =
\frac{\int_\Omega f \delta(\psi_p(R,Z)-\psi_{p0})|\vec\nabla\psi_p| \dV}
...
This program reads in the output file above
