...
"output":
{
    ...
    "fsa":
    { // [Optional, Experimental] indicate that fsa should be computed during
      // simulation with full resolution. Note that this adds approx 20\%
      // runtime to the simulation and has minimal effect on accuracy of fsa
...
\midrule
    ...
    lparparbphi\_tt   & $(\nu_{\parallel,i} \Delta_\parallel U_{\parallel,i} + U_{\parallel,i} \Lambda_{N_i,\parallel})b_\varphi$ &
...
// only works if fsa actually exists and n, Npsi, Neta equal the ones in the data file
