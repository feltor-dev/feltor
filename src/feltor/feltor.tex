...
\subsection{Zonal flow energy, "Zonal-Flow-Energy": true}
...
Z\_cta2dX  & Dataset & 3 (time, psi, theta) & Convoluted toroidal average Eq.~\eqref{eq:cta} in the magnetic plane. \\
\bottomrule
\label{table:diag}
\end{longtable}
where Z $\in$ \{X, Y\_tt\}
...
\item "cta2dX":  If true, save \_cta2dX in table \ref{table:diag}.
