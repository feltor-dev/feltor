...
\end{align*}
 ...
 in the model.
If we further neglect $\beta$ this becomes a two-dimensional submanifold
of physical parameters.
\begin{tcolorbox}[title=Note]
    In order to invert the system (i.e. given numerical parameters find the
    corresponding physical parameters) we have to fix one (or more) physical
