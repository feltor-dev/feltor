...
U_\parallel$ we use centered differences, which in the density case mandates
artificial parallel diffusion to be stable (centered in space is
unconditionally unstable without diffusion).
