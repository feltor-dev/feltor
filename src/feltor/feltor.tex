...
\begin{align}
\frac{1}{B^2}(\nabla\times \vec B)^R &= \frac{R_0 }{B^2R}\frac{\partial I}{\partial Z} \\
\frac{1}{B^2}(\nabla\times \vec B)^Z &= -\frac{R_0 }{B^2R}\frac{\partial I}{\partial R} \\
\frac{1}{B^2}(\nabla\times \vec B)^\varphi &= -\frac{1}{B^2R^2}\left(\frac{1}{R}\frac{\partial}{\partial R}\left(\frac{1}{R}\frac{\partial\psi}{\partial R}\right) + \frac{\partial^2 \psi}{\partial Z^2}\right)
