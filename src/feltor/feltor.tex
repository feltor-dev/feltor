...
"density":
{
    "ntilde" :
    {
        ...
        "rk4eps" : 1e-2, //accuracy for fieldline integration (takes a long time,
        // a low value is sufficient for most applications)
...
\subsubsection{ Fixed end-time/ equidistant output in adaptive timestepper}
