...
\item "std\_fsa":  If true, save \_std\_fsa in table \ref{table:diag}.
\item "ifs\_lcfs":  If true, save \_ifs\_lcfs in table \ref{table:diag}.
\item "ifs\_norm":  If true, save \_ifs\_norm in table \ref{table:diag}.
\end{itemize}
