...
struct SNe{
  ...
  (nuparallel*(0. + (1.*Z*((-1.5707963267948966*(-10 + R)*Cos(Pi*Z)*
               Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t))/
             Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) + 
            (1.5707963267948966*Z*Cos(Pi*(-10 + R))*Sin(P)*Sin(Pi*t)*
               Sin(Pi*Z))/Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) \
+ (10.*Cos(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
       ...
       (1.*(-10 + R)*R*((4.934802200544679*Z*Cos(Pi*(-10 + R))*
            ...
            (1.5707963267948966*Power(Z,2)*Cos(Pi*(-10 + R))*Sin(P)*
               Sin(Pi*t)*Sin(Pi*Z))/
             Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5) + 
            (1.5707963267948966*Cos(Pi*(-10 + R))*Sin(P)*Sin(Pi*t)*
               Sin(Pi*Z))/Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) \
- (10.*Z*Cos(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
             (R*Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5)) + 
            (4.934802200544679*(-10 + R)*Sin(P)*Sin(Pi*(-10 + R))*
               Sin(Pi*t)*Sin(Pi*Z))/
             Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))))/
        Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) + 
       (20*((-1.5707963267948966*(-10 + R)*Cos(P)*Cos(Pi*Z)*
               Sin(Pi*(-10 + R))*Sin(Pi*t))/
             Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) + 
            (1.5707963267948966*Z*Cos(P)*Cos(Pi*(-10 + R))*Sin(Pi*t)*
               Sin(Pi*Z))/Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) \
- (10.*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
       ...
       (1.*R*Z*((-4.934802200544679*(-10 + R)*Cos(Pi*(-10 + R))*
            ...
            (1.5707963267948966*Cos(Pi*Z)*Sin(P)*Sin(Pi*(-10 + R))*
               Sin(Pi*t))/Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) \
+ (31.41592653589793*Cos(P)*Cos(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
             (R*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) - 
            (1.5707963267948966*(-10 + R)*Z*Cos(Pi*(-10 + R))*Sin(P)*
               Sin(Pi*t)*Sin(Pi*Z))/
             Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5) - 
            (10.*(-10 + R)*Cos(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
             (R*Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5)) - 
            (10.*Cos(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
             (Power(R,2)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
- (4.934802200544679*Z*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))/
             Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))))/
  ...
  (R*(1 + 0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
        ...
        (Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z)*
           ((1.*(-10 + R)*Z)/
             ...
             (25.132741228718345*beta*Z*
              ...
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3)))/
         (3.*Sqrt(-mue)) + (2*Pi*Cos(2*Pi*Z)*Sin(2*P)*Sin(2*Pi*(-10 + R))*
           Sin(2*Pi*t)*((-1.*(-10 + R))/
              Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) - 
             (6.283185307179586*beta*
                (R*(499.99999999999994 - 20.*R + 1.*Power(R,2) + 
                  ...
                  (Z*(-7.957747154594767 + 0.3183098861837907*R - 
                   ...
                   Sin(4*Pi*R))*Sin(4*Pi*t)*Sin(4*Pi*Z))/
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2)))/
         (3.*Sqrt(-mue))) + 1.5707963267948966*R*Cos(Pi*Z)*Sin(P)*
      Sin(Pi*(-10 + R))*Sin(Pi*t)*
        ...
        (Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z)*
           ((-1.*(-10 + R))/
             ...
             (6.283185307179586*beta*
              ...
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2)))/
         (3.*Sqrt(-mue))) + R*(1 + 
        0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
      ((4.*R*(-20. + 2.*R)*taue*Z)/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3) - 
        (2.*taue*Z)/Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) + 
        (2.792526803190927*R*Z*Cos(2*Pi*R)*Power(Sin(2*P),2)*Sin(2*Pi*R)*
           Power(Sin(2*Pi*t),2)*Power(Sin(2*Pi*Z),2))/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) - 
        (2*R*(-20. + 2.*R)*Z*(-2.*taue + 
             0.2222222222222222*Power(Sin(2*P),2)*Power(Sin(2*Pi*R),2)*
              Power(Sin(2*Pi*t),2)*Power(Sin(2*Pi*Z),2)))/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3) + 
             ...
             (12.566370614359172*beta*(-20. + 2.*R)*Sin(4*Pi*R)*
                Sin(4*Pi*t)*(R*
                  ...
                  ((-79.57747154594767 + 11.140846016432674*R - 
                     ...
                     0.07957747154594767*R*Z*Sin(4*P))*Sin(4*Pi*Z)))/
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3)))/
         (3.*Sqrt(-mue)) + (2*Pi*Cos(2*Pi*(-10 + R))*Sin(2*P)*Sin(2*Pi*t)*
           Sin(2*Pi*Z)*((1.*Z)/
              Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) + 
             (6.283185307179586*beta*Sin(4*Pi*R)*Sin(4*Pi*t)*
                (R*(499.99999999999994 - 20.*R + 1.*Power(R,2) + 
                  ...
                  ((-79.57747154594767 + 11.140846016432674*R - 
                     ...
                     0.07957747154594767*R*Z*Sin(4*P))*Sin(4*Pi*Z)))/
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2)))/
         (3.*Sqrt(-mue))) + 1.5707963267948966*R*Cos(Pi*(-10 + R))*Sin(P)*
      Sin(Pi*t)*Sin(Pi*Z)*(0. - 
        (2.*R*taue*Z)/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) + 
      ...
      (0. - (2.*R*taue*Z)/
        ...
        (Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z)*
         ...
         (3.*Sqrt(-mue))) + R*(1 + 
        0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
      ((0.044444444444444446*(900. - 20.*R + 1.*Power(R,2) + 
             1.*Power(Z,2))*Cos(2*P)*Sin(2*P)*Power(Sin(2*Pi*R),2)*
           Power(Sin(2*Pi*t),2)*Power(Sin(2*Pi*Z),2))/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) + 
             ...
             (0.3141592653589793*beta*Sin(4*P)*Sin(4*Pi*t)*
                (Z*(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2))*
                  ...
                  ((-5000. - 30.*Power(R,2) + 1.*Power(R,3) - 
                   ...
                   Sin(4*Pi*Z)))/
              Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2)))/
         (3.*Sqrt(-mue))) + 0.5*R*Cos(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*
      Sin(Pi*Z)*((taue*(250000.00000000006 - 80.*Power(R,3) + 
             1.*Power(R,4) + 1000.0000000000001*Power(Z,2) + 
             1.*Power(Z,4) + R*(-40000. - 80.*Power(Z,2)) + 
...
- (3.141592653589793*Power(-10 + R,2)*Z*Cos(Pi*Z)*Sin(P)*
  ...
  (R*(1 + 0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
      ((-4.*taui*Z*(-1000. + 20.*R - 2.*Power(Z,2)))/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3) - 
        (4.*taui*Z)/Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) + 
        (3*Pi*Cos(3*Pi*Z)*(3.7699111843077517*R*Cos(3*Pi*R)*Sin(3*P) - 
             0.06*Z*Cos(3*P)*Sin(3*Pi*R))*Sin(3*Pi*t))/
         (500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2)) + 
     ...
     R*(1 + 0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
      ((4.*R*(-20. + 2.*R)*taui*Z)/
         Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),3) - 
        (2.*taui*Z)/Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2) - 
...
struct SUe{
    double mue,mui,taue,taui,eta,beta,nuperp,nuparallel;
    DG_DEVICE double operator()(double R, double Z, double P, double t)const{
    return 0. + (2*Pi*Cos(2*Pi*t)*Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*Z))/
   (3.*Sqrt(-mue)) - (eta*(1 + 
       0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))*
  ...
  ((41.8879020478639*R*taue*(-50. + 1.*R - 0.1*Power(Z,2))*Cos(2*Pi*Z)*
     ...
     (2.6666666666666665*R*taue*Z*Sin(2*P)*Sin(2*Pi*R)*Sin(2*Pi*t)*
      ...
      (Sqrt(-mue)*Power(500. - 20.*R + 1.*Power(R,2) + 1.*Power(Z,2),2)))/
   (R*(1 + 0.5*Sin(P)*Sin(Pi*(-10 + R))*Sin(Pi*t)*Sin(Pi*Z))) - 
  (nuparallel*(0. + (1.*Z*((-2.0943951023931953*(-10 + R)*Cos(2*Pi*Z)*
               Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
+ (2.0943951023931953*Z*Cos(2*Pi*(-10 + R))*Sin(2*P)*Sin(2*Pi*t)*
               Sin(2*Pi*Z))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
...
- (13.333333333333334*Z*Cos(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*
       ...
       (20*((-4.1887902047863905*(-10 + R)*Cos(2*P)*Cos(2*Pi*Z)*
               Sin(2*Pi*(-10 + R))*Sin(2*Pi*t))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
+ (4.1887902047863905*Z*Cos(2*P)*Cos(2*Pi*(-10 + R))*Sin(2*Pi*t)*
               Sin(2*Pi*Z))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
- (80*Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
       ...
       (1.*R*Z*((-13.15947253478581*(-10 + R)*Cos(2*Pi*(-10 + R))*
               Cos(2*Pi*Z)*Sin(2*P)*Sin(2*Pi*t))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
+ (2.0943951023931953*Power(-10 + R,2)*Cos(2*Pi*Z)*Sin(2*P)*
               Sin(2*Pi*(-10 + R))*Sin(2*Pi*t))/
             (Sqrt(-mue)*Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),
                1.5)) - (2.0943951023931953*Cos(2*Pi*Z)*Sin(2*P)*
               Sin(2*Pi*(-10 + R))*Sin(2*Pi*t))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) \
+ (80*Pi*Cos(2*P)*Cos(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (3.*Sqrt(-mue)*R*
               Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) - 
            (2.0943951023931953*(-10 + R)*Z*Cos(2*Pi*(-10 + R))*Sin(2*P)*
               Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (Sqrt(-mue)*Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),
                1.5)) - (13.333333333333334*(-10 + R)*Cos(2*P)*
            ...
            (40*Cos(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (3.*Sqrt(-mue)*Power(R,2)*
               Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) - 
            (13.15947253478581*Z*Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*
               Sin(2*Pi*Z))/
             (Sqrt(-mue)*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)))))/
        Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))))/R + 
...
+ (71.6197243913529 - 1.5915494309189535*R + 
  ...
  (nuperp*((1.*(-10 + R)*Z*((2*Pi*Cos(2*Pi*Z)*Sin(2*P)*
       ...
       (1 - (1.*Power(Z,2))/(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)))*
        ((2*Pi*Cos(2*Pi*(-10 + R))*Sin(2*P)*Sin(2*Pi*t)*Sin(2*Pi*Z))/
           (3.*Sqrt(-mue)) + (beta*Pi*Cos(4*Pi*(-10 + R))*Sin(4*P)*
             Sin(4*Pi*t)*Sin(4*Pi*Z))/mue) - 
       (20.*Z*((2*Cos(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (3.*Sqrt(-mue)) + 
  ...
  (nuparallel*(0. + (1.*Z*((-2.0943951023931953*(-10 + R)*Cos(2*Pi*Z)*
       ...
       (1.*R*Z*((-13.15947253478581*(-10 + R)*Cos(2*Pi*(-10 + R))*
            ...
            (2.0943951023931953*Power(-10 + R,2)*Cos(2*Pi*Z)*Sin(2*P)*
               Sin(2*Pi*(-10 + R))*Sin(2*Pi*t))/
             Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5) - 
            (2.0943951023931953*Cos(2*Pi*Z)*Sin(2*P)*Sin(2*Pi*(-10 + R))*
               Sin(2*Pi*t))/
             Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2)) + 
            (80*Pi*Cos(2*P)*Cos(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (3.*R*Sqrt(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2))) - 
            (2.0943951023931953*(-10 + R)*Z*Cos(2*Pi*(-10 + R))*Sin(2*P)*
               Sin(2*Pi*t)*Sin(2*Pi*Z))/
             Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5) - 
            (13.333333333333334*(-10 + R)*Cos(2*P)*Sin(2*Pi*(-10 + R))*
               Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (R*Power(400 + 1.*Power(-10 + R,2) + 1.*Power(Z,2),1.5)) - 
            (40*Cos(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*Sin(2*Pi*Z))/
             (3.*Power(R,2)*Sqrt(400 + 1.*Power(-10 + R,2) + 
                 1.*Power(Z,2))) - 
            (13.15947253478581*Z*Sin(2*P)*Sin(2*Pi*(-10 + R))*Sin(2*Pi*t)*
