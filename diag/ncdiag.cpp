...
//         dg::HVec sf = dg::evaluate(qprofile, g1d_out);
    ...
    const dg::HVec psipR =  dg::evaluate( dg::geo::solovev::PsipR(gp), g3d_out);
    const dg::HVec psipRR = dg::evaluate( dg::geo::solovev::PsipRR(gp), g3d_out);
    const dg::HVec psipZ =  dg::evaluate( dg::geo::solovev::PsipZ(gp), g3d_out);
    const dg::HVec psipZZ = dg::evaluate( dg::geo::solovev::PsipZZ(gp), g3d_out);
    const dg::HVec psipRZ = dg::evaluate( dg::geo::solovev::PsipRZ(gp), g3d_out);
...
//         start3dp[0] = i; //set specific time  
        ...
        for( unsigned j=0;j<5; j++)
        {
            ...
            toroidal_average.reduce(fields3d[j],data2davg);
...
//             dg::blas1::axpby(1.0,data2dflucmid,-1.0,data2davg,data2dflucmid); //Compute z fluctuation
        ...
        toroidal_average.reduce(vor3d,vor2davg);
        ...
        toroidal_average.reduce(Deperp3d,Deperp2davg);
        ...
        toroidal_average.reduce(Depsip3d,Depsip2davg);
        ...
        toroidal_average.reduce(Depsip3dfluc,Depsip2dflucavg);
        //fluctuation
//         err2d = nc_put_vara_double( ncid2d, dataIDs2d[12],   start2d, count2d, Depsip2dflucavg.data());
        ...
        toroidal_average.reduce(Lperpinv3d,Lperpinv2davg);
