...
#OMPFLAG=-qsmp=omp
CFLAGS=-Wall -std=c++17 -DWITHOUT_VCL -mcpu=power9 # -mavx -mfma #flags for CC
...
NVCCFLAGS= -std=c++17 -Xcompiler "-mcpu=power9 -Wall" --extended-lambda# -mavx -mfma" #flags for NVCC
