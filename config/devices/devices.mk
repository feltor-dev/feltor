...
CFLAGS+=-x c++ -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_CPP
LIBS=-L/opt/homebrew/Cellar/netcdf/4.8.1_2/lib -lnetcdf -L/opt/homebrew/Cellar/hdf5/1.12.2/lib -lhdf5 -lhdf5_hl
INCLUDE+= -I/opt/homebrew/Cellar/netcdf/4.8.1_2/include # To add LLVM and see if it solves compilator problems
