...
static double interior( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs);
template< class Matrix>
static double boundary( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs);
template< int s0, int s1, class Matrix>
static double edge( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs);
template< int s0, int s1, class Matrix>
static double corner( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs);

/*! @brief Arakawa class implements the Arakawa scheme for various BC
 *
 */
class Arakawa
{
  ...
  public:
    ...
    template<class Matrix>
    void per_per(const Matrix& lhs, const Matrix& rhs, Matrix& jac);
    template<class Matrix>
    void per_dir(const Matrix& lhs, const Matrix& rhs, Matrix& jac);
    template<class Matrix>
    void dir_per(const Matrix& lhs, const Matrix& rhs, Matrix& jac);
    template<class Matrix>
    void dir_dir(const Matrix& lhs, const Matrix& rhs, Matrix& jac);
};


template< class Matrix>
void Arakawa::per_per( const Matrix& lhs, 
                        const Matrix& rhs, 
                        Matrix& jac)
{
...
template<class Matrix>
void Arakawa::per_dir(  const Matrix& lhs, 
                        const Matrix& rhs, 
                        Matrix& jac)
{
    const size_t rows = jac.rows(), cols = jac.cols();
...
template<class Matrix>
void Arakawa::dir_per( const Matrix& lhs, 
                        const Matrix& rhs, 
                        Matrix& jac)
{
    const size_t rows = jac.rows(), cols = jac.cols();
...
template< class Matrix>
void Arakawa::dir_dir(  const Matrix& lhs, 
                        const Matrix& rhs, 
                        Matrix& jac)
{
    const size_t rows = jac.rows(), cols = jac.cols();
 ...
 */
template< class Matrix>
double interior( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs) 
{
    double jacob;
 ...
 *  @tparam Matrix Matrix class that has to provide m(i, j) access, a rows() and a cols() method.
 ...
 */
template< class Matrix>
double boundary( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs) 
{
    double jacob;
 ...
 *  @return the unnormalized value of the Arakawa bracket
 */
template <int s0, int s1, class Matrix> //indicates where the interior is
double edge( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs) 
{
    const size_t rows = lhs.rows(), cols = lhs.cols();
 ...
 *  @tparam Matrix Matrix class that has to provide m(i, j) access (normally inferred by the compiler)
 ...
 *  @return the unnormalized value of the Arakawa bracket
 */
template <int s0, int s1, class Matrix> //indicates the interior
double corner( const size_t i0, const size_t j0, const Matrix& lhs, const Matrix& rhs) 
{
    double jacob;
