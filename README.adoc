...
On Linux `libjsoncpp-dev` is available through the package managment system.
For a manual build clone https://www.github.com/open-source-parsers/jsoncpp[JsonCpp] and follow the build instructions in the README. After this, link the
include path
[source,sh]
----
cd ~/include
