...
become possible to develop on https://www.visualstudio.com/[Microsoft Visual Studio].
We have not yet investigated how to compile and run FELTOR's own programs on Windows,
but it is possible to use it as a library.
____
...
For the download of the library and its dependencies from github you may want
to consider a software solution like for example https://desktop.github.com
