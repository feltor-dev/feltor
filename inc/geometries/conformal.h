 ...
 */
template< class container>
struct ConformalRingGrid3d : public dg::Grid3d
{
    typedef dg::ConformalCylindricalTag metric_category; //!< metric tag
    typedef ConformalRingGrid2d<container> perpendicular_grid; //!< the two-dimensional grid type

    template< class Generator>
    ConformalRingGrid3d( const Generator& generator, unsigned n, unsigned Nx, unsigned Ny, unsigned Nz, dg::bc bcx=dg::DIR) :
 ...
 */
template< class container>
struct ConformalRingGrid2d : public dg::Grid2d
{
    typedef dg::ConformalCylindricalTag metric_category;
    template< class Generator>
    ConformalRingGrid2d( const Generator& hector, unsigned n, unsigned Nx, unsigned Ny, dg::bc bcx=dg::DIR):
        dg::Grid2d( 0, 1., 0., 2*M_PI, n,Nx,Ny, bcx, dg::PER)
    {
        ConformalRingGrid3d<container> g( hector, n,Nx,Ny,1,bcx);
