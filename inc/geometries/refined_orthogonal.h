...
struct RingGrid3d : public dg::refined::Grid3d
{
    ...
    { 
        ...
        construct( psip, psipR, psipZ, lapPsip, psi_0, psi_1, gp.R_0, 0, firstline);
    ...
    { 
        construct( psi, psiX, psiY, laplacePsi, psi_0, psi_1, x0, y0, firstline);
    }
    ...
    void construct( Psi psi, PsiX psiX, PsiY psiY, LaplacePsi laplacePsi,
            ...
            double x0, double y0, int firstline)
    {
