...
struct FuncDirPer
{
    FuncDirPer( const Geometry& c, double R0, double psi_0, double psi_1, double k):
...
{
    EllipticDirPerM( const Geometry& c, double R0, double psi_0, double psi_1, double k): func_(c, R0, psi_0, psi_1, k), bmod_(c, R0), br_(c, R0), bz_(c, R0) {}
    double operator()(double R, double Z, double phi) const {
        return this->operator()(R,Z);}
    double operator()(double R, double Z) const {
    ...
    private:
    FuncDirPer<Geometry> func_;
    dg::geo::Bmodule<Geometry> bmod_;
    dg::geo::BR<Geometry> br_;
    dg::geo::BZ<Geometry> bz_;
};
...
struct FuncDirNeu
{
    FuncDirNeu( const Geometry& c, double psi_0, double psi_1, double R_blob, double Z_blob, double sigma_blob, double amp_blob):
...
struct BmodTheta
{
    BmodTheta( const Geometry& c, double R0): R_0_(R0), bmod_(c, R0){}
    double operator()(double R,double Z, double phi) const{
        return this->operator()(R,Z);}
    double operator()(double R,double Z) const{
...
{
    EllipticDirNeuM( const Geometry& c, double R0, double psi_0, double psi_1, double R_blob, double Z_blob, double sigma_blob, double amp_blob): R_0_(R0), 
...
struct FuncXDirNeu
{
    FuncXDirNeu( const Geometry& c, double psi_0, double psi_1):
...
{
    EllipticXDirNeuM( const Geometry& c, double R0, double psi_0, double psi_1): R_0_(R0), 
...
{
    EllipticBlobDirNeuM( const Geometry& c, double psi_0, double psi_1, double R_blob, double Z_blob, double sigma_blob, double amp_blob): 
...
{
    EllipticDirSimpleM( const Geometry& c, double psi_0, double psi_1, double R_blob, double Z_blob, double sigma_blob, double amp_blob): func_(c, psi_0, psi_1, R_blob, Z_blob, sigma_blob, amp_blob) {}
    double operator()(double R, double Z, double phi) const {
...
struct TestFunction
{
    TestFunction( const Geometry& c, double R0) :  
        bhatR_(c, R0),
        bhatZ_(c, R0),
        bhatP_(c, R0) {}
    /**
...
//         return cos(phi*kP); //NEU
    ...
    private:
    dg::geo::BHatR<Geometry> bhatR_;
    dg::geo::BHatZ<Geometry> bhatZ_;
    dg::geo::BHatP<Geometry> bhatP_;
};
...
{
    DeriTestFunction( const Geometry& c, double R0) :
        bhatR_(c, R0),
        bhatZ_(c, R0),
        bhatP_(c, R0) {}
/**
