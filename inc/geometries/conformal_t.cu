...
typedef dg::FieldAligned< conformal::refined::RingGrid3d<dg::HVec> , dg::IHMatrix, dg::HVec> DFA;
...
int main( int argc, char* argv[])
{
    ...
    conformal::refined::RingGrid3d<dg::HVec> g3d(multiple_x, multiple_y, gp, psi_0, psi_1, n_ref, n, Nx, Ny,Nz, dg::DIR);
    conformal::refined::RingGrid2d<dg::HVec> g2d = g3d.perp_grid();
