...
int main( int argc, char* argv[])
{
    ...
    const dg::DVec ones = dg::evaluate( dg::one, g);
    ...
    dg::CartesianGrid2d g2d( gp.R_0 -1.2*gp.a, gp.R_0 + 1.2*gp.a, -1.2*gp.a, 1.2*gp.a, 1, 1e4, 1e4, dg::PER, dg::PER);
    dg::HVec vec  = dg::evaluate( iris, g2d);
    dg::HVec R  = dg::evaluate( dg::coo1, g2d);
