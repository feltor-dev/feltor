...
thrust::host_vector<double> pullback( BinaryOp f, const ribeiro::RingGrid2d<container>& g)
{
...
///@cond
template<class container>
thrust::host_vector<double> pullback( double(f)(double,double), const ribeiro::RingGrid2d<container>& g)
{
...
thrust::host_vector<double> pullback( TernaryOp f, const ribeiro::RingGrid3d<container>& g)
{
    thrust::host_vector<double> vec( g.size());
...
///@cond
template<class container>
thrust::host_vector<double> pullback( double(f)(double,double,double), const ribeiro::RingGrid3d<container>& g)
{
