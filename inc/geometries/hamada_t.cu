...
typedef dg::FieldAligned< hamada::RingGrid3d<dg::HVec> , dg::IHMatrix, dg::HVec> DFA;
...
int main( int argc, char* argv[])
{
    ...
    std::cout << "Constructing hamada grid ... \n";
    t.tic();
    hamada::RingGrid3d<dg::HVec> g3d(gp, psi_0, psi_1, n, Nx, Ny,Nz, dg::DIR);
    hamada::RingGrid2d<dg::HVec> g2d = g3d.perp_grid();
    ...
    err = nc_create( "hamada.nc", NC_NETCDF4|NC_CLOBBER, &ncid);
    int dim3d[2];
...
//     dg::blas1::axpby( 1., ones, -1., g2d.vol(), temp0);
    ...
    solovev::hamada::FieldY fieldY(gp);
...
//     dg::CartesianGrid2d g2dC( gp.R_0 -1.2*gp.a, gp.R_0 + 1.2*gp.a, -1.2*gp.a, 1.2*gp.a, 1, 1e3, 1e3, dg::PER, dg::PER);
    ...
    t.tic();
    DFA fieldaligned( hamada::Field( gp, g3d.x(), g3d.f_x()), g3d, gp.rk4eps, dg::NoLimiter()); 

    dg::DS<DFA, dg::DMatrix, dg::HVec> ds( fieldaligned, hamada::Field(gp, g3d.x(), g3d.f_x()), dg::normed, dg::centered);
