 ...
 * where \c i iterates over @b all elements inside the container. If \c container has the \c VectorVectorTag, \c i recursively loops over all entries.
 * If the container sizes do not match, the result is undefined.
 */
