...
int main()
{
    ...
    t.tic();
    {
    dg::Elliptic<dg::cartesian::Grid2d, dg::DMatrix, dg::DVec> pol( grid, dg::not_normed, dg::centered);
    pol.set_chi( chi);
    t.toc();
    ...
    {
    dg::Elliptic<dg::cartesian::Grid2d, dg::DMatrix, dg::DVec> pol_forward( grid, dg::not_normed, dg::forward);
    ...
    {
    dg::Elliptic<dg::cartesian::Grid2d, dg::DMatrix, dg::DVec> pol_backward( grid, dg::not_normed, dg::backward);
