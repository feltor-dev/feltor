...
int main()
{
    ...
    std::cin >> eps;
    dg::CylindricalGrid<dg::DVec> grid( R_0, R_0+lx, 0, ly, 0,lz, n, Nx, Ny,Nz, bcx, dg::PER, dg::PER);
    ...
    t.tic();
    dg::GeneralElliptic<dg::CylindricalGrid<dg::DVec>, dg::DMatrix, dg::DVec, dg::DVec> laplace(grid, dg::not_normed, dg::centered);
