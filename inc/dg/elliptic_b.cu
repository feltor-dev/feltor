...
int main()
{
    ...
    std::cin >> eps;
    dg::cylindrical::Grid3d<dg::DVec> grid( R_0, R_0+lx, 0, ly, 0,lz, n, Nx, Ny,Nz, bcx, bcy, dg::PER);
    ...
    t.tic();
    dg::Elliptic<dg::cylindrical::Grid3d<dg::DVec>, dg::DMatrix, dg::DVec> laplace(grid, dg::not_normed, dg::centered);
    dg::Elliptic<dg::cylindrical::Grid3d<dg::fDVec>, dg::fDMatrix, dg::fDVec> flaplace(grid, dg::not_normed, dg::centered);
    ...
    dg::Inverse<dg::Elliptic<dg::cylindrical::Grid3d<dg::fDVec>, dg::fDMatrix, dg::fDVec>, dg::fDVec> inverse( flaplace, fx, 10, 1e-15, 0);
