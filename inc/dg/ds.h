...
#ifdef MPI_VERSION
typedef dg::DS< dg::MPI_FieldAligned<dg::IDMatrix, dg::BijectiveComm< dg::IDVec, dg::DVec >, dg::NearestNeighborComm< dg::IDVec, dg::DVec>, dg::DVec>, dg::MDMatrix, dg::MDVec > MDDS; //!< MPI device DS type
typedef dg::DS< dg::MPI_FieldAligned<dg::IHMatrix, dg::BijectiveComm< dg::IHVec, dg::HVec >, dg::NearestNeighborComm< dg::IHVec, dg::HVec>,  dg::HVec>, dg::MHMatrix, dg::MHVec > MHDS; //!< MPI host DS type
#endif //MPI_VERSION
///@}
