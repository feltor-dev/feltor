...
int main()
{
    ...
    const DVec h_x = dg::transfer<DVec>( dg::evaluate( exp, g1d));
    const DVec h_n = dg::transfer<DVec>( dg::evaluate( function, g2d));
    const DVec h_z = dg::transfer<DVec>( dg::evaluate( function, g3d));
