...
#pragma omp parallel for 
    ...
    for( int j=0; j<right; j++)
    {
        ...
        ell_multiply_kernel( data, cols_idx, data_idx, num_rows, num_cols, 3, 3, left, right, x, y);
}
...
#pragma omp parallel for 
    ...
    for( int j=0; j<right; j++)
    {
        ...
        ell_multiply_kernel( data, cols_idx, data_idx, num_rows, num_cols, 2, 3, left, right, x, y);
...
#pragma omp parallel for
    ...
    for( int k=0; k<3; k++)
    {
        ...
        ell_multiply_kernel( data, cols_idx, data_idx, num_rows, num_cols, 2, 3, left, 1, x, y);
