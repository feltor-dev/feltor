...
int main ()
{
    ...
    int new_N = dg::detail::exponential_Xref( 3, g, both, both_abs);
    double sum = 0;
    ...
    //dg::RefinedGridX3d g3d( 4,4,1,1, 0.,1., 0.,2.*M_PI, 0.,1., 0.25, 0.1, 5, 3, 12, 80, 10);
    dg::RefinedGridX3d g3d( 4,4, 0.,1., 0.,2.*M_PI, 0.,1., 0.25, 0.1, 5, 3, 12, 80, 10);
    dg::RefinedGridX2d g2d( g3d);
    g3d.display();
    g2d.display();
