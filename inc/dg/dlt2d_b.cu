...
int main()
{
    ...
    HMatrix hforwardy = dgtensor<double, n>( tensor(Ny, forward), tensor<double, n>(Nx, delta));
    DMatrix dforwardy( hforwardy);
    HMatrix hforwardx = dgtensor<double, n>( tensor<double,n>(Ny, delta), tensor<double, n>(Nx, forward));
