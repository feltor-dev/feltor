...
int main()
{
    ...
    dg::Helmholtz2< dg::DMatrix, dg::DVec, dg::DVec > gamma2inv(  grid2d,grid2d.bcx(),grid2d.bcy(), alpha,dg::centered);
    dg::Elliptic< dg::DMatrix, dg::DVec, dg::DVec > lapperp(grid2d,grid2d.bcx(), grid2d.bcy(), dg::normed, dg::centered);
