...
int main( int argc, char* argv[])
{
    ...
    dg::cartesian::MPIGrid3d grid( 0., lx, 0, ly, 0, lz, n, Nx, Ny,Nz, bcx, dg::PER,dg::PER, comm);
    ...
    dg::Timer t;
    t.tic();
    dg::Elliptic<dg::cartesian::MPIGrid3d, dg::MDMatrix, dg::MDVec> A ( grid, dg::not_normed); 
    t.toc();
