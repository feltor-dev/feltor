...
//     gp.display( std::cout);
    ...
    for (unsigned i=0;i<3;i++) { 
        ...
        dg::MPI_Grid2d g2d( Rmin,Rmax, Zmin,Zmax,  n, Nxn ,Nyn, comm);
...
//     dg::Grid2d<double> g2d( Rmin,Rmax, Zmin,Zmax,  n, Nx, Ny); 
    ...
    if(rank==0)std::cout << "computing dzDIR" << std::endl;
    ...
    if(rank==0)std::cout << "computing dzNEU" << std::endl;
    dg::MPI_FieldAligned<dg::IDMatrix, dg::BijectiveComm< thrust::device_vector<int>, dg::DVec >, dg::DVec>    
...
//     dg::DZ<dg::DMatrix, dg::MDVec> dzNEU( field, g3d, g3d.hz(), rk4eps, dg::DefaultLimiter(), dg::NEU);
    
//     dg::Grid3d<double> g3dp( Rmin,Rmax, Zmin,Zmax, z0, z1,  n, Nx, Ny, 1);
    
//     dg::DZ<dg::DMatrix, dg::MDVec> dz2d( field, g3dp, g3d.hz(), rk4eps, dg::DefaultLimiter(), dg::NEU);
    ...
    const dg::MDVec solutiondzz = dg::evaluate( deriNEU2, g3d);
    const dg::MDVec solutiondzTdz = dg::evaluate( deriNEUT2, g3d);
