...
int main( int argc, char* argv[])
{
    ...
    dg::cylindrical::MPIGrid<dg::MDVec> grid( R_0, R_0+lx, 0, ly, 0,lz, n, Nx, Ny,Nz, bcx, dg::PER, dg::PER, comm);
    ...
    t.tic();
    dg::Elliptic<dg::cylindrical::MPIGrid<dg::MDVec>, dg::MDMatrix, dg::MDVec> laplace(grid, dg::not_normed, dg::centered);
